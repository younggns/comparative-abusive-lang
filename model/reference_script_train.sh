...
###########################################
# RNN ( context has been added to original text )
# original encoder_size = 200   ( context + original )
###########################################

CUDA_VISIBLE_DEVICES=0 python train_rnn_ctx.py --batch_size 256 --encoder_size 200 --num_layer 1 --hidden_dim 200 --lr 0.001 --num_train_steps 10000 --is_save 0 --dr 0.8 --use_glove 1 --o_type 0 --c_text 1 --c_type 0 --attn 0 --ltc 0 --graph_prefix 'rnn-ctx' --data_path '../data/target/0/' 
