...
class SingleEncoderModelBiSingle:
    ...
    def _create_gru_model_bi(self):
        ...
        with tf.name_scope('text_RNN') as scope:
            ...
            with tf.compat.v1.variable_scope("text_GRU", reuse=False, initializer=tf.keras.initializers.Orthogonal()):
    ...
    def _add_context_gru(self):
        ...
        with tf.name_scope('text_RNN') as scope:
            ...
            with tf.compat.v1.variable_scope("text_GRU", reuse=True, initializer=tf.keras.initializers.Orthogonal()):
