...
class SingleEncoderModelBiSingle:
    ...
    def _create_placeholders(self):
        ...
        with tf.name_scope('text_placeholder'):
            ...
            # self.encoder_type_o    = tf.compat.placeholder(tf.float32, shape=[self.batch_size, 5], name="encoder_type_o")   # [batch] - tweet type 0-5
            ...
            # self.encoder_type_c    = tf.compat.placeholder(tf.float32, shape=[self.batch_size, 5], name="encoder_type_c")   # [batch] - tweet type 0-5
