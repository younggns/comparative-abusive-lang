...
class SingleEncoderModelBi:
    ...
    def _add_attention_match_rnn(self):
        ...
        with tf.variable_scope("self-matching"):
            ...
            self.params = get_attn_params(self.final_encoder_dimension/2, initializer = tf.contrib.layers.xavier_initializer)
    ...
    def build_graph(self):
        ...
        if Params.is_context_use : self._add_context_gru()
        else :
            if self.attn  : self._add_attention_match_rnn()
