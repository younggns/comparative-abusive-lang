...
def add_GRU(inputs, inputs_len, cell=None, cell_fn=tf.compat.v1.nn.rnn_cell.GRUCell, hidden_dim=100, layers=1, scope="add_GRU", output=0, is_training=True, reuse=None, dr_input_keep_prob=1.0, dr_output_keep_prob=1.0, is_bidir=False, is_bw_reversed=False, is_residual=False):
    '''
    ...
    '''
    with tf.compat.v1.variable_scope(name_or_scope=scope, reuse=reuse, initializer=tf.compat.v1.orthogonal_initializer()):
