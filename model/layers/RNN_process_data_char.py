...
class ProcessData:
    ...
    def __init__(self, data_path):
        ...
        # load data
        self.train_set = self.load_data(Params.CHAR_DATA_TRAIN_TRANS, Params.DATA_TRAIN_TYPE, Params.CHAR_DATA_TRAIN_LABEL)
        self.dev_set  = self.load_data(Params.CHAR_DATA_DEV_TRANS, Params.DATA_DEV_TYPE, Params.CHAR_DATA_DEV_LABEL)
        self.test_set  = self.load_data(Params.CHAR_DATA_TEST_TRANS, Params.DATA_TEST_TYPE, Params.CHAR_DATA_TEST_LABEL)
